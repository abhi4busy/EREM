...
var url='http://www.eremnews.com/mobile/recent_post.php';
...
var url='http://www.eremnews.com/mobile/sports.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/business.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/arts-culture.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/lifestyle.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/science-technology.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/entertainment.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/multimedia.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
...
var url='http://www.eremnews.com/mobile/multimedia-arts.php';
callRestGet(url,
		function(result){
			var data = jQuery.parseJSON(result.responseText);
			articalDetails(data);
